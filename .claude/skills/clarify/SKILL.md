...
1. **Be concise**: Cut unnecessary words (but don't sacrifice clarity)
1. **Be active**: "Save changes" not "Changes will be saved"
1. **Be human**: "Oops, something went wrong" not "System error encountered"
1. **Be helpful**: Tell users what to do, not just what happened
1. **Be consistent**: Use same terms throughout (don't vary for variety)
